...
VkPipeline PipelineManager::createVkPipeline(const GraphicsPipelineConfig& config, VkPipelineLayout layout) {
    ...
    if (!m_shaderManager.isValid(config.shaderStages.vertexShader) || !m_shaderManager.isValid(config.shaderStages.fragmentShader)) {
    ...
    vertexShaderStageInfo.module = m_shaderManager.get(config.shaderStages.vertexShader).get();
    ...
    fragmentShaderStageInfo.module = m_shaderManager.get(config.shaderStages.fragmentShader).get();
    ...
    if (config.shaderStages.geometryShader) {
        ...
        geometryShaderStageInfo.module = m_shaderManager.get(config.shaderStages.geometryShader).get();
    ...
    if (config.shaderStages.tessControlShader) {
        ...
        tessControlShaderStageInfo.module = m_shaderManager.get(config.shaderStages.tessControlShader).get();
    ...
    if (config.shaderStages.tessEvalShader) {
        ...
        tessEvalShaderStageInfo.module = m_shaderManager.get(config.shaderStages.tessEvalShader).get();
    ...
    if (config.shaderStages.computeShader) {
        ...
        computeShaderStageInfo.module = m_shaderManager.get(config.shaderStages.computeShader).get();
