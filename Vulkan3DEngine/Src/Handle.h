...
DEFINE_HANDLE_TYPE(RenderPassHandle, uint32_t)
DEFINE_HANDLE_TYPE(AttachmentHandle, uint32_t)
DEFINE_HANDLE_TYPE(FrameBufferHandle, uint32_t)
DEFINE_HANDLE_TYPE(PrefabHandle, uint32_t)
DEFINE_HANDLE_TYPE(PrefabInstanceHandle, uint32_t)
DEFINE_HANDLE_TYPE(RenderNodeHandle, uint32_t)
DEFINE_HANDLE_TYPE(RenderGraphHandle, uint32_t)
DEFINE_HANDLE_TYPE(SemaphoreHandle, uint32_t)
